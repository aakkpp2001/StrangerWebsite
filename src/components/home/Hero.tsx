...
import { drawHeroScene } from '@/components/pixelart/HeroScene';

export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Pixel-art hero scene */}
      <div className="absolute inset-0 z-0">
        <PixelArtCanvas draw={drawHeroScene} scale={3} className="opacity-90" />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h1
          className="animate-fade-up font-serif text-6xl md:text-8xl lg:text-9xl text-cream-100 text-glow italic font-light tracking-wide-sm mb-6 md:mb-8"
        ...
        <p
          className="animate-fade-up font-serif text-xl md:text-3xl text-cream-200 font-light italic leading-snug mb-8 md:mb-10"
        ...
        <p
          className="animate-fade-up font-body text-sm md:text-base text-cream-400 font-light leading-relaxed max-w-2xl mx-auto mb-10 md:mb-14"
        ...
        <div
          className="animate-fade-up flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6"
